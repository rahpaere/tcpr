...
static const char *filter_path = "/tmp/tcpr-filter.socket";
static const char *application_path = "/tmp/tcpr-application.socket";
static const char *state_file = "/tmp/tcpr-application.state";
