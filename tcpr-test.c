...
int main(int argc, char **argv)
{
	...
	send_segment(external_log, 0x0a000002, 0x0a000003, 8888, 9999,
			TH_SYN, 0xdeadbeef, 0, 0, NULL, 0, NULL);
	recv_segment(internal_log, 0x0a000002, 0x0a000004, 8888, 9999,
			TH_SYN, 0xdeadbeef, 0, 0, NULL, 0, NULL);

	fprintf(stderr, "Application: SYN ACK\n");
	send_segment(internal_log, 0x0a000004, 0x0a000002, 9999, 8888,
			TH_SYN | TH_ACK, 0xcafebabe, 0xdeadbeef + 1,
			0, NULL, 0, NULL);
	recv_segment(external_log, 0x0a000003, 0x0a000002, 9999, 8888,
			TH_SYN | TH_ACK, 0xcafebabe, 0xdeadbeef + 1,
			0, NULL, 0, NULL);
	...
	recv_update(0x0a000003, 0x0a000004, 7777, 6666,
			0x0a000002, 0x0a000004, 8888, 9999,
	...
	send_update(0x0a000004, 0x0a000003, 6666, 7777,
			0x0a000002, 0x0a000004, 8888, 9999,
	...
	send_segment(internal_log, 0x0a000005, 0x0a000002, 9999, 8888,
			TH_SYN, 0xfeedbead, 0, 0, NULL, 0, NULL);

	fprintf(stderr, "     Filter: SYN ACK\n");
	recv_segment(internal_log, 0x0a000002, 0x0a000005, 8888, 9999,
			TH_SYN | TH_ACK, 0xdeadbeef + 4, 0xfeedbead + 1,
			0, NULL, 0, NULL);

	fprintf(stderr, "     Filter: update\n");
	recv_update(0x0a000003, 0x0a000005, 7777, 6666,
			0x0a000002, 0x0a000005, 8888, 9999,
	...
	fprintf(stderr, "Application: update\n");
	send_update(0x0a000005, 0x0a000003, 6666, 7777,
			0x0a000002, 0x0a000005, 8888, 9999,
	...
	recv_update(0x0a000003, 0x0a000005, 7777, 6666,
			0x0a000002, 0x0a000005, 8888, 9999, 0, 0, 0, 0);
	...
	fprintf(stderr, "Application: update\n");
	send_update(0x0a000003, 0x0a000005, 7777, 6666,
			0x0a000002, 0x0a000005, 8888, 9999,
			0xcafebabe + 5, 0xdeadbeef + 5, 0, TCPR_HAVE_ACK);
