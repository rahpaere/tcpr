...
int main(int argc, char **argv)
{
	...
	send_segment(external_log, net | 2, net | 3, 8888, 9999,
			TH_FIN | TH_ACK, 0xdeadbeef + 1, 0xcafebabe + 1,
			0, NULL, 0, NULL);
	...
	send_segment(internal_log, net | 4, net | 2, 9999, 8888,
			TH_ACK, 0xcafebabe + 1, 0xdeadbeef + 2,
			0, NULL, 0, NULL);
	...
	send_segment(internal_log, net | 4, net | 2, 9999, 8888,
			TH_FIN | TH_ACK, 0xcafebabe + 1, 0xdeadbeef + 2,
			0, NULL, 0, NULL);
	recv_segment(external_log, net | 3, net | 2, 9999, 8888,
			TH_FIN | TH_ACK, 0xcafebabe + 1, 0xdeadbeef + 2,
			0, NULL, 0, NULL);
	...
	send_segment(external_log, net | 2, net | 3, 8888, 9999,
			TH_ACK, 0xdeadbeef + 2, 0xcafebabe + 2,
			0, NULL, 0, NULL);
	recv_segment(internal_log, net | 2, net | 4, 8888, 9999,
			TH_ACK, 0xdeadbeef + 2, 0xcafebabe + 2,
			0, NULL, 0, NULL);
